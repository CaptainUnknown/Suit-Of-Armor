...
async function getNFTObjs() {
    ...
    if (armorNFTsContractOneVar.result.length != 0) {
        for (var i = 0; i < armorNFTsContractOneVar.result.length; i++) {
            ...
            rarityOwnedContractOne[i] = oneTempMeta.attributes[0].value; //change 0 to 2
        }
    }
    if (armorNFTsContractTwoVar.result.length != 0) {
        for (var i = 0; i < armorNFTsContractTwoVar.result.length; i++) {
            ...
            rarityOwnedContractTwo[i] = twoTempMeta.attributes[0].value;
        }
    }
    if (armorNFTsContractThreeVar.result.length != 0) {
        for (var i = 0; i < armorNFTsContractThreeVar.result.length; i++) {
            ...
            rarityOwnedContractThree[i] = threeTempMeta.attributes[0].value;
    ...
    if (armorNFTsContractFourVar.result.length != 0) {
        for (var i = 0; i < armorNFTsContractFourVar.result.length; i++) {
            ...
            rarityOwnedContractFour[i] = fourTempMeta.attributes[0].value;
        }
    }
    ...
    console.log(rarityOwnedContractTwo);
    console.log(rarityOwnedContractTwo.length);
    console.log(rarityOwnedContractThree);
    console.log(rarityOwnedContractThree.length);
    console.log(rarityOwnedContractFour);
    console.log(rarityOwnedContractFour.length);
